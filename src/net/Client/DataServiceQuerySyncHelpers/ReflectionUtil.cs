...
namespace Microsoft.WindowsAzure.MediaServices.Client.DataServiceQuerySyncHelpers
{
    ...
    internal static class ReflectionUtil
    {
        ...
        static ReflectionUtil()
        {
            ...
            ReflectionUtil.s_methodMap = new Dictionary<MethodInfo, SequenceMethod>((IEqualityComparer<MethodInfo>)EqualityComparer<MethodInfo>.Default);
            ReflectionUtil.s_inverseMap = new Dictionary<SequenceMethod, MethodInfo>((IEqualityComparer<SequenceMethod>)EqualityComparer<SequenceMethod>.Default);
            foreach (MethodInfo allLinqOperator in ReflectionUtil.GetAllLinqOperators())
            {
                ...
                {
                    ReflectionUtil.s_methodMap.Add(allLinqOperator, index);
                    ReflectionUtil.s_inverseMap[index] = allLinqOperator;
                }
            }
        }
        ...
        /// <summary>Check to see if this is an Any or an All method</summary>
        ...
        internal static string GetCanonicalMethodDescription(MethodInfo method)
        {
            ...
            {
                Predicate<Type> isGenericParameterPredicate = (Predicate<Type>)(type => type.IsGenericParameter);
                genericArgumentOrdinals = ((IEnumerable<Type>)method.GetGenericArguments()).Where<Type>((Func<Type, bool>)(t => isGenericParameterPredicate(t))).Select<Type, KeyValuePair<Type, int>>((Func<Type, int, KeyValuePair<Type, int>>)((t, i) => new KeyValuePair<Type, int>(t, i))).ToDictionary<KeyValuePair<Type, int>, Type, int>((Func<KeyValuePair<Type, int>, Type>)(r => r.Key), (Func<KeyValuePair<Type, int>, int>)(r => r.Value));
            }
